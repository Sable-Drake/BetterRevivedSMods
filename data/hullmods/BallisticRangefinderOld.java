...
public class BallisticRangefinderOld extends BaseHullMod {
	...
	public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
		...
		if (ship.getVariant().getSMods().contains("ballistic_rangefinder") || ship.getVariant().getSModdedBuiltIns().contains("ballistic_rangefinder")) {
...
//		label.setHighlightColors(h, Misc.MOUNT_BALLISTIC, h, h);
		...
		if (isForModSpec) {
			...
			return;
		} else if (ship.getVariant().getSMods().contains("ballistic_rangefinder") || ship.getVariant().getSModdedBuiltIns().contains("ballistic_rangefinder")) {
